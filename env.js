 ...
 * for example: if the APP_ENV is staging, the bundle id will be com.aomlcompanion.staging
 */

// TODO: Replace these values with your own

const BUNDLE_ID = 'com.aomlcompanion'; // ios bundle id
const PACKAGE = 'com.aomlcompanion'; // android package name
const NAME = 'AOMLCompanion'; // app name
const EXPO_ACCOUNT_OWNER = 'expo-owner'; // expo account owner
const EAS_PROJECT_ID = 'c3e1075b-6fe7-4686-aa49-35b46a229044'; // eas project id
const SCHEME = 'AOMLCompanion'; // app scheme
...
const client = z.object({
  ...
  OPENAI_MAX_TOKENS: z.number(),

  // Google Vision API Configuration
  GOOGLE_VISION_API_KEY: z.string().min(1),
  GOOGLE_VISION_API_URL: z.string().min(1),
});
...
const _clientEnv = {
  ...
  OPENAI_MAX_TOKENS: Number(process.env.OPENAI_MAX_TOKENS),
